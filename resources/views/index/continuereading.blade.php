    ...
    <div class="row">
        <div class="col-9">
            <div style="position: relative;">
                <img src="{{ asset('images\blog-01.jpg') }}" style="width:50em;">
            ...
            <div class="mt-5">
                <h1 style="font-size: 26px;  line-height: 1.3846;">
                    8 Inspiring Ways
                    to
                    Wear Dresses in the Winter </h1>
        ...
        <div class="col-3 container mt-0">
            <div>
            ...
            <div>
                <h6 class="text-uppercase mb-4 font-weight-bold mt-5">CATEGORIES </h6>
                <hr>
            ...
            <div class=" mt-5" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{ asset('images\product-min-01.jpg.webp') }}" class=" mt-0 mb-0 h-80 "
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <a href="#" class="card-text ml-5">White Shirt With Pleant Details</a>
            ...
            <div class=" mt-3" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{ asset('images\product-min-02.jpg.webp') }}" class=" mt-0 mb-0 h-80 "
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
            ...
            <div class=" mt-3" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{ asset('images\product-min-03.jpg.webp') }}" class=" mt-0 mb-0 h-80 "
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
            ...
            <div class="tags mt-5">
                ...
                <div class="justify-content-around mt-3">
                    ...
                    <span>
                        <button type="button" class="btn btn-outline-secondary mt-2 !important">Streetstyle</button>
                    </span>
                    <span>
                        <button type="button" class="btn btn-outline-secondary mt-2 !important">Crafts</button>
                    </span>
                </div>
            </div>
